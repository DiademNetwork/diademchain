...
import (
	...
	registry_v1 "github.com/diademnetwork/diademchain/registry/v1"
	registry_v2 "github.com/diademnetwork/diademchain/registry/v2"
)
...
type RegistryFactoryFunc func(diademchain.State) common.Registry
...
func NewRegistryFactory(v RegistryVersion) (RegistryFactoryFunc, error) {
	switch v {
	case RegistryV1:
		return func(s diademchain.State) common.Registry {
