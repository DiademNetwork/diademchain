...
func (c *ChainConfigTestSuite) TestFeatureFlagEnabledSingleValidator() {
	...
	chainID := "default"
	addr1 := diadem.Address{ChainID: chainID, Local: diadem.LocalAddressFromPublicKey(pubKeyB64_1)}
	//setup fake contract
...
func (c *ChainConfigTestSuite) TestPermission() {
	...
	addr1 := diadem.Address{ChainID: "", Local: diadem.LocalAddressFromPublicKey(pubKeyB64_1)}
	addr2 := diadem.Address{ChainID: "", Local: diadem.LocalAddressFromPublicKey(pubKeyB64_2)}
	//setup fake contract
	validators := []*diadem.Validator{
		&diadem.Validator{
			PubKey: pubKeyB64_1,
...
func (c *ChainConfigTestSuite) TestFeatureFlagEnabledFourValidators() {
	...
	addr3 := diadem.Address{ChainID: "", Local: diadem.LocalAddressFromPublicKey(pubKeyB64_3)}
	pubKeyB64_4, _ = encoder.DecodeString(pubKey4)
	addr4 := diadem.Address{ChainID: "", Local: diadem.LocalAddressFromPublicKey(pubKeyB64_4)}
