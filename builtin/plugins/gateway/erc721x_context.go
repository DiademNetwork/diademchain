...
type erc721xStaticContext struct {
	...
	// Address of ERC721X contract deployed to Diadem EVM.
	tokenAddr   diadem.Address
	contractABI *abi.ABI
}

func newERC721XStaticContext(ctx contract.StaticContext, tokenAddr diadem.Address) *erc721xStaticContext {
...
func (c *erc721xStaticContext) balanceOf(owner diadem.Address, tokenID *big.Int) (*big.Int, error) {
...
func newERC721XContext(ctx contract.Context, tokenAddr diadem.Address) *erc721xContext {
...
func (c *erc721xContext) safeTransferFrom(from, to diadem.Address, tokenID *big.Int, amount *big.Int) error {
