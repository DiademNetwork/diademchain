...
var (
	chainId = "default"
	addr1   = diadem.MustParseAddress("default:0xb16a379ec18d4093666f8f38b11a3071c920207d")
	addr2   = diadem.MustParseAddress("default:0xfa4c7920accfd66b86f5fd0e69682a79f762d49e")
	addr3   = diadem.MustParseAddress("default:0x5cecd1f7261e1f4c684e297be3edf03b825e01c4")
	addr4   = diadem.MustParseAddress("default:0x46ecd1f7261e1f4c684e297be3edf03b825e01c4")
	addr5   = diadem.MustParseAddress("default:0x76ecd1f7261fcf4c684e297be3edf03b825e01c4")
)
...
func (dw *DeployerWhitelistTestSuite) TestDeployerWhitelistContract() {
	...
	pctx := plugin.CreateFakeContext(addr1, addr1).WithBlock(diadem.BlockHeader{
		ChainID: chainId,
		Time:    time.Now().Unix(),
	})
	...
	require.NoError(err)
	gotAddr := diadem.UnmarshalAddressPB(get.Deployer.Address)
