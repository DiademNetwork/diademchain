...
var (
	plasmaValidators = []diadem.Address{
		diadem.MustParseAddress("default:0x0e99fc16e32e568971908f2ce54b967a42663a26"), // plasma-0
		diadem.MustParseAddress("default:0xac3211caecc45940a6d2ba006ca465a647d8464f"), // plasma-1
		diadem.MustParseAddress("default:0x69c48768dbac492908161be787b7a5658192df35"), // plasma-2
		diadem.MustParseAddress("default:0x2a3a7c850586d4f80a12ac1952f88b1b69ef48e1"), // plasma-3
		diadem.MustParseAddress("default:0x4a1b8b15e50ce63cc6f65603ea79be09206cae70"), // plasma-4
		diadem.MustParseAddress("default:0x0ce7b61c97a6d5083356f115288f9266553e191e"), // plasma-5
	}
	doubledDelegator = diadem.MustParseAddress("default:0xDc93E46f6d22D47De9D7E6d26ce8c3b7A13d89Cb")
	doubledValidator = diadem.MustParseAddress("default:0xa38c27e8cf4a443e805065065aefb250b1e1cef2")
	basisPoints      = diadem.BigUInt{big.NewInt(1e4)} // do not change
	billionth        = diadem.BigUInt{big.NewInt(1e9)}
)
...
func adjustDoubledDelegationAmount(delegation Delegation) *types.BigUInt {
	...
	if validatorMatch && delegatorMatch {
		...
		amount.Div(&delegation.Amount.Value, diadem.NewBigUIntFromInt(2))
	}
...
func CalculateFraction(frac diadem.BigUInt, total diadem.BigUInt, granular bool) diadem.BigUInt {
	if granular {
...
func CalculatePreciseFraction(frac diadem.BigUInt, total diadem.BigUInt, granular bool) diadem.BigUInt {
	denom := basisPoints
	if granular {
		denom = billionth
	}
...
func calculateShare(delegation diadem.BigUInt, total diadem.BigUInt, rewards diadem.BigUInt, granular bool) diadem.BigUInt {
	frac := common.BigZero()
	denom := &basisPoints
	if granular {
		denom = &billionth
...
func calculateWeightedDelegationAmount(delegation Delegation, granular bool) diadem.BigUInt {
