...
import (
	...
	legacy_v1 "github.com/diademnetwork/diademchain/receipts/chain/v1"
	legacy_v2 "github.com/diademnetwork/diademchain/receipts/chain/v2"
	"github.com/diademnetwork/diademchain/receipts/handler"
	"github.com/pkg/errors"
)

type ReceiptReaderWriter interface {
	diademchain.ReadReceiptHandler
	diademchain.WriteReceiptHandler
	diademchain.ReceiptHandlerStore
...
// ReceiptHandlerProvider implements diademchain.ReceiptHandlerProvider interface
...
func NewReceiptHandlerProvider(
	eventHandler diademchain.EventHandler, resolveCfg ResolveReceiptHandlerCfg,
...
func (h *ReceiptHandlerProvider) StoreAt(blockHeight int64, v2Feature bool) (diademchain.ReceiptHandlerStore, error) {
	return h.resolve(blockHeight, v2Feature)
}

func (h *ReceiptHandlerProvider) ReaderAt(blockHeight int64, v2Feature bool) (diademchain.ReadReceiptHandler, error) {
	return h.resolve(blockHeight, v2Feature)
}

func (h *ReceiptHandlerProvider) WriterAt(blockHeight int64, v2Feature bool) (diademchain.WriteReceiptHandler, error) {
	return h.resolve(blockHeight, v2Feature)
}
