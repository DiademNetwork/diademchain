...
import (
	...
	lplugin "github.com/diademnetwork/go-diadem/plugin"
...
var (
	...
	addr2 = diadem.MustParseAddress("chain:0x5cecd1f7261e1f4c684e297be3edf03b825e01c5")
	...
	awardsSoures = []*ktypes.KarmaSource{
		{Name: "award1", Count: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(21)}},
		{Name: "award2", Count: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(3)}},
		{Name: "award3", Count: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(17)}},
		{Name: "award4", Count: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(11)}},
	}
	...
	require.NoError(t,
		karmaContract.DepositCoin(
			...
			&ktypes.KarmaUserAmount{
				User:   user1,
				Amount: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(20)},
			}),
	)
...
func TestKarmaCoinUpkeep(t *testing.T) {
	...
	require.NoError(t, karmaContract.DepositCoin(karmaCtx1, &ktypes.KarmaUserAmount{User: user1, Amount: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(104)}}))
	...
	require.NoError(t, karmaContract.DepositCoin(karmaCtx2, &ktypes.KarmaUserAmount{User: user2, Amount: &types.BigUInt{Value: *diadem.NewBigUIntFromInt(104)}}))
...
*/
func GetKarma(t *testing.T, karmaContractCtx lplugin.StaticContext, user diadem.Address, sourceName string) int64 {
...
func isActive(t *testing.T, karmaContract *karma.Karma, ctx lplugin.StaticContext, contract diadem.Address) bool {
