...
// DiademAddress is a free data retrieval call binding the contract method 0x37179db8.
//
// Solidity: function diademAddress() constant returns(address)
func (_MainnetGatewayContract *MainnetGatewayContractCaller) DiademAddress(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _MainnetGatewayContract.contract.Call(opts, out, "diademAddress")
	return *ret0, err
}
...
//
// Solidity: function diademAddress() constant returns(address)
func (_MainnetGatewayContract *MainnetGatewayContractSession) DiademAddress() (common.Address, error) {
	return _MainnetGatewayContract.Contract.DiademAddress(&_MainnetGatewayContract.CallOpts)
}

// DiademAddress is a free data retrieval call binding the contract method 0x37179db8.
//
// Solidity: function diademAddress() constant returns(address)
func (_MainnetGatewayContract *MainnetGatewayContractCallerSession) DiademAddress() (common.Address, error) {
	return _MainnetGatewayContract.Contract.DiademAddress(&_MainnetGatewayContract.CallOpts)
}
...
func (_MainnetGatewayContract *MainnetGatewayContractTransactor) SetDiademAddress(opts *bind.TransactOpts, _diademAddress common.Address, sig []byte) (*types.Transaction, error) {
	return _MainnetGatewayContract.contract.Transact(opts, "setDiademAddress", _diademAddress, sig)
}
...
func (_MainnetGatewayContract *MainnetGatewayContractSession) SetDiademAddress(_diademAddress common.Address, sig []byte) (*types.Transaction, error) {
	return _MainnetGatewayContract.Contract.SetDiademAddress(&_MainnetGatewayContract.TransactOpts, _diademAddress, sig)
}
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MainnetGatewayContractDiademCoinReceivedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MainnetGatewayContractDiademCoinReceived)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MainnetGatewayContractDiademCoinReceivedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MainnetGatewayContractDiademCoinReceivedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}
...
type MainnetGatewayContractDiademCoinReceived struct {
	From            common.Address
	Amount          *big.Int
	DiademCoinAddress common.Address
	Raw             types.Log // Blockchain specific contextual infos
}
...
func (_MainnetGatewayContract *MainnetGatewayContractFilterer) FilterDiademCoinReceived(opts *bind.FilterOpts, from []common.Address) (*MainnetGatewayContractDiademCoinReceivedIterator, error) {
	...
	logs, sub, err := _MainnetGatewayContract.contract.FilterLogs(opts, "DiademCoinReceived", fromRule)
	if err != nil {
		return nil, err
	}
	return &MainnetGatewayContractDiademCoinReceivedIterator{contract: _MainnetGatewayContract.contract, event: "DiademCoinReceived", logs: logs, sub: sub}, nil
}
...
func (_MainnetGatewayContract *MainnetGatewayContractFilterer) WatchDiademCoinReceived(opts *bind.WatchOpts, sink chan<- *MainnetGatewayContractDiademCoinReceived, from []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MainnetGatewayContract.contract.WatchLogs(opts, "DiademCoinReceived", fromRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MainnetGatewayContractDiademCoinReceived)
				if err := _MainnetGatewayContract.contract.UnpackLog(event, "DiademCoinReceived", log); err != nil {
					return err
				}
				event.Raw = log
