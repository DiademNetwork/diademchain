...
func DefaultDiademCoinTGConfig(rpcProxyPort int32) *TransferGatewayConfig {
	return &TransferGatewayConfig{
		ContractEnabled:               false,
		Unsafe:                        false,
		OracleEnabled:                 false,
		...
		NumMainnetBlockConfirmations:  15,
		OracleLogLevel:                "info",
		OracleLogDestination:          "file://diademcoin_tgoracle.log",
		OracleStartupDelay:            5,
...
func (c *TransferGatewayConfig) GetWithdrawerAddressBlacklist() ([]diadem.Address, error) {

	addrList := make([]diadem.Address, 0, len(c.WithdrawerAddressBlacklist))
