...
import (
	...
	lauth "github.com/diademnetwork/diademchain/auth"
...
func (c *TxLimiterConfig) DeployerAddresses() ([]diadem.Address, error) {
...
type OriginValidator struct {
	...
	allowedDeployers []diadem.Address
	deployValidation bool
	callValidation   bool
}

func NewOriginValidator(period uint64, allowedDeployers []diadem.Address, deployValidation, callValidation bool) OriginValidator {
	dv := OriginValidator{
		period:           period,
...
func (dv *OriginValidator) validateDeployer(deployer diadem.Address) error {
...
func (dv *OriginValidator) validateCaller(caller diadem.Address, nonce, currentBlockHeight uint64) error {
