...
import (
	...
	"github.com/diademnetwork/diademchain/e2e/engine"
...
var (
	...
	LogDest  = flag.String("log-destination", "file://diadem.log", "Log Destination")
...
func NewConfig(name, testFile, genesisTmpl, yamlFile string, validators, account, numEthAccounts int) (*lib.Config, error) {
	...
	for i := 0; i < validators; i++ {
		n := node.NewNode(int64(i), conf.BaseDir, conf.DiademPath, conf.ContractDir, genesisTmpl, yamlFile)
		n.LogLevel = *LogLevel
