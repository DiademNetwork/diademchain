...
import (
	...
	"github.com/diademnetwork/diademchain/builtin/plugins/plasma_cash/config"
	"github.com/diademnetwork/diademchain/builtin/plugins/plasma_cash/oracle"
...
func main() {
	...
	diademCfg.PlasmaCash.OracleEnabled = true

	plasmaCashConfig, err := config.LoadSerializableConfig(diademCfg.ChainID, diademCfg.PlasmaCash)
	if err != nil {
