...
import (
	...
	"github.com/diademnetwork/go-diadem/builtin/types/dposv2"
...
diadem staking list-delegations 0x0ca3d6bf201ce53c7ddc3cb397ae33a68ed4a328
`
...
diadem staking total-delegation 0x751481F4db7240f4d5ab5d8c3A5F6F099C824863

# Get total delegations using an Ethereum address
diadem staking total-delegation eth:0x751481F4db7240f4d5ab5d8c3A5F6F099C824863
`
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if addr.ChainID == "eth" {
				...
				addr = diadem.UnmarshalAddressPB(resp.To)
			}
...
diadem staking check-delegation 0x0ca3d6bf201ce53c7ddc3cb397ae33a68ed4a328 0x751481F4db7240f4d5ab5d8c3A5F6F099C824863
`
...
diadem staking get-mapping 0x751481F4db7240f4d5ab5d8c3A5F6F099C824863

# Get mapping using an Ethereum address
diadem staking get-mapping eth:0x0BE2BC95ea604a5ac4ECcE0F8570fe58bC9C320A
`
...
diadem staking balance 0x751481F4db7240f4d5ab5d8c3A5F6F099C824863

# Get balance using an Ethereum address
diadem staking balance eth:0x0BE2BC95ea604a5ac4ECcE0F8570fe58bC9C320A
`
...
diadem staking withdrawal-receipt eth:0x751481F4db7240f4d5ab5d8c3A5F6F099C824863

Get the withdrawal receipt using a DappChain Address
diadem staking withdrawal-receipt 0xCA08d2DB4563A64415bC16F17a0107A82DA622B7
`
...
func WithdrawalReceiptCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			err = cli.StaticCallContract(
				commands.DiademGatewayName, "WithdrawalReceipt",
...
diadem staking check-all-delegations eth:0x751481F4db7240f4d5ab5d8c3A5F6F099C824863

Display all delegations of a particular delegator using a DappChain address
diadem staking check-all-delegations 0xCA08d2DB4563A64415bC16F17a0107A82DA622B7
`
...
# List all candidates
diadem staking list-candidates
`
